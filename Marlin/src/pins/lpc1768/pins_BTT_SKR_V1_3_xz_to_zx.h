 ...
 */
#define Z_DIAG_PIN                         P1_29  // X-
#define Y_DIAG_PIN                         P1_27  // Y-
#define X_DIAG_PIN                         P1_25  // Z-
 ...
 */
  ...
  #if Z_HOME_DIR < 0
    #define Z_MAX_PIN                      P1_28  // X+
  #else
    #define Z_MIN_PIN                      P1_28  // X+
  #endif
#else
  #define Z_MIN_PIN                        P1_29  // X-
  #define Z_MAX_PIN                        P1_28  // X+
#endif
  ...
  #if X_HOME_DIR < 0
    #define X_MAX_PIN                      P1_24  // Z+
  #else
    #define X_MIN_PIN                      P1_24  // Z+
  #endif
#else
  #define X_MIN_PIN                        P1_25  // Z-
  #define X_MAX_PIN                        P1_24  // Z+
#endif

#if E0_STALL_SENSITIVITY
  #define E0_STOP_PIN                  E0_DIAG_PIN
  #if E0_HOME_DIR < 0
    #define E0_MAX_PIN                      P1_24  // Z+
  #else
    #define E0_MIN_PIN                      P1_24  // Z+
  #endif
#else
  #define E0_MIN_PIN                        P1_25  // Z-
  #define E0_MAX_PIN                        P1_24  // Z+
#endif
...
#define Z_DIR_PIN                          P2_06
#define Z_ENABLE_PIN                       P2_01
#ifndef Z_CS_PIN
