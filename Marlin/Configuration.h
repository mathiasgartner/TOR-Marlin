...
#define PULLEY_RADIUS_2PI 2.0 * PI * PULLEY_RADIUS
#define CORD_THICKNESS_EFFECTIVE CORD_THICKNESS / CORD_LAYERS_ON_PULLEY
#define CORD_THICKNESS_PI CORD_THICKNESS * PI
#define CORD_THICKNESS_SQR CORD_THICKNESS * CORD_THICKNESS
#define PULLEY_RADIUS_OVER_CORD_THICKNESS PULLEY_RADIUS / CORD_THICKNESS
#define PULLEY_RADIUS_OVER_CORD_THICKNESS_SQR PULLEY_RADIUS_OVER_CORD_THICKNESS * PULLEY_RADIUS_OVER_CORD_THICKNESS
